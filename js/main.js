/* Event Listener 1: This event listener listens for a double click on the h2 with the id:
...
/* Event Listener 3: This event listener listens for the mouse to click down on the h1
and for the mouse to be released. Once heard, this listener changes the color of the
h1 from black (original color) to white (when mouse is down) and finally blue
(when mouse is up).*/

document.getElementById( 'headlineOne' ).addEventListener( 'mousedown', mouseDown );
document.getElementById( 'headlineOne' ).addEventListener( 'mouseup', mouseUp );

function mouseDown () {
    document.getElementById( 'headlineOne' ).style.color = 'white';
}

function mouseUp () {
    document.getElementById( 'headlineOne' ).style.color = 'blue';
}
